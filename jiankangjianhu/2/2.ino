...
const char *ssid = "荣耀手机";
const char *password = "123456789";
// 在 ThingsCloud 控制台的设备详情页中，复制以下设备连接信息
// https://console.thingscloud.xyz
#define THINGSCLOUD_MQTT_HOST "e0l51baviolhdhie"
#define THINGSCLOUD_DEVICE_ACCESS_TOKEN "cOlqMsCGhA"
#define THINGSCLOUD_PROJECT_KEY "sh-3-mqtt.iot-api.com"
//======================================================
